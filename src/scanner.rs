            ...
            if is_aplha_exists && !is_digit_exists {
                match word.as_str() {
                    "any" => self.add_token(
                        ...
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "boolean" => self.add_token(
                        TokenType::Bool,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ...
                    "catch" => self.add_token(
                        TokenType::Catch,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "class" => self.add_token(
                        TokenType::Class,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "const" => self.add_token(
                        TokenType::Const,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "continue" => self.add_token(
                        TokenType::Continue,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "debugger" => self.add_token(
                        TokenType::Debugger,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "default" => self.add_token(
                        TokenType::Default,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "delete" => self.add_token(
                        TokenType::Delete,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ...
                    "export" => self.add_token(
                        TokenType::Export,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "extends" => self.add_token(
                        TokenType::Extends,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "error" => self.add_token(
                        TokenType::Error,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "declare" => self.add_token(
                        TokenType::Declare,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ...
                    "function" => self.add_token(
                        TokenType::Function,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "constructor" => self.add_token(
                    ...
                    "implements" => self.add_token(
                        TokenType::Implements,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "import" => self.add_token(
                        TokenType::Import,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ...
                    "instanceof" => self.add_token(
                        TokenType::InstanceOf,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "interface" => self.add_token(
                        TokenType::Interface,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ...
                    "package" => self.add_token(
                        TokenType::Package,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "private" => self.add_token(
                        TokenType::Private,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "protected" => self.add_token(
                        TokenType::Protected,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "public" => self.add_token(
                        TokenType::Public,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ...
                    "static" => self.add_token(
                        TokenType::Static,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "string" => self.add_token(
                        TokenType::String,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "super" => self.add_token(
                        TokenType::Super,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
                    ),
                    "switch" => self.add_token(
                        TokenType::Switch,
                        TokenKind::Keyword,
                        String::from(word),
                        self.word_buffer_column,
